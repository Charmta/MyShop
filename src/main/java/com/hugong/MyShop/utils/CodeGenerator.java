...
//    public static final String PACKAGE_NAME = "com.hugong.MyShop";
//
//    public static void main(String[] args)  throws Exception{
//        String[] tables = new String[] {"cart","role","t_order","t_order_det","t_product","user"};//表名数组
//        String[] tablePrefixs = new String[] {"t_"}; //表示表的公共头部数组
...
//        // 从试图获取
//        config.setUrl("jdbc:mysql://localhost:3306/mytest?useSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai");
//        config.setDriverName("com.mysql.cj.jdbc.Driver");
//        config.setUsername("root");
//        config.setPassword("535363");
